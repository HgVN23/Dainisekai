const lore = [
		...
		section: [
			{
				main: 'Truyền thuyết',
				content: [
					'Những người đã từng tới văn phòng Re:Life chắc hẳn sẽ nghĩ những nhân viên nơi đây như là Chúa hoặc một vị thần nào đó. Về ngoài thì nhìn đúng là như vậy nhưng về bản chất thì đó là nơi ban cho cơ hội thứ hai khi cuộc đời trước kia chưa được hoàn thiện. Người chết sẽ đến thiên đàng hoặc xuống địa ngục hoặc đơn giản là không còn tồn tại nữa. Nhưng một “biến số” đã xuất hiện trên con đường đó và “biến số” ấy là văn phòng Re:Life',
					...
					'Nếu muốn biết thêm chỉ còn cách gặp văn phòng Re:Life thôi. Tất nhiên nếu tự sát để đến đó thì ai cũng có thể rồi. Vậy nên hãy cứ sống theo như thế giới đã sắp đặt và tận hướng. Nếu “may mắn” thì biết đâu bạn sẽ được chọn và có câu trả lời ...',
					'Văn phòng Re:Life chỉ là truyền thuyết và nó không có thật... Phải vậy không nhỉ?'
				]
			},
			{
	...
	{
		id: 1,
		title: 'Đại vũ trụ『Dainisekai』',
		section: [
			{
				main: 'Khái niệm',
				content: [
					'Là tên đại vũ trụ của thế giới dành cho những người chuyển sinh',
					'Đại vũ trụ được tạo ra bởi văn phòng Re:Life bằng ■ vào 20/03/2023, đồng thời cũng là khoảng thời gian những người chuyển sinh đời đầu xuất hiện',
