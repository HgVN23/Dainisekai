const lore = [
		...
		section: [
			{
				main: `Truyền thuyết`,
				content: [
					`Những người đã từng tới ${nameLocation[1]} chắc hẳn sẽ nghĩ những nhân viên nơi đây như là Chúa hoặc một vị thần nào đó. Về ngoài thì nhìn đúng là như vậy nhưng về bản chất thì đó là nơi ban cho cơ hội thứ hai khi cuộc đời trước kia chưa được hoàn thiện. Người chết sẽ đến thiên đàng hoặc xuống địa ngục hoặc đơn giản là không còn tồn tại nữa. Nhưng một “biến số” đã xuất hiện trên con đường đó và “biến số” ấy là ${nameLocation[1]}`,
					`Ai đã thành lập nên văn phòng? Những nhân viên ấy là người thật hay là thiên thần hay là hiện thân của linh hồn? Ai là người đứng đầu? Ý đồ của họ là gì? Tại sao họ lại có sức mạnh như vậy mà cho những người đã chết không chút do dự? Cái giá sau này liệu sẽ xuất hiện? Thiên đàng được đô thị hóa 4.0? Phòng ẩn trên con đường lên thiên đàng? Liệu có thật là được sống cuộc đời thứ hai hay chỉ là một thế giới ảo? Liệu những thứ trên có thật hay chỉ là những người hấp hối đang bị đưa ra làm thí nghiệm thông qua não bộ? Có vẻ các hoài nghi đang đi xa dần nội dung ban đầu rồi nhỉ?`,
					`Nếu muốn biết thêm chỉ còn cách gặp ${nameLocation[1]} thôi. Tất nhiên nếu tự sát để đến đó thì ai cũng có thể rồi. Vậy nên hãy cứ sống theo như thế giới đã sắp đặt và tận hướng. Nếu “may mắn” thì biết đâu bạn sẽ được chọn và có câu trả lời ...`,
					`${nameLocation[1]} chỉ là truyền thuyết và nó không có thật... Phải vậy không nhỉ?`
				]
			},
			{
				main: `Điều kiện để đến văn phòng`,
				content: [
					`Gặp phải cái chết không thể ngờ tới trước tuổi 30 và mang trong mình nhiều nuối tiếc chưa thể thực hiện được khi còn sống`
				]
			},
			{
				...
				content: [
					...
					`Có được ba điều ước và ước được bất cứ điều gì miễn là thỏa mãn các điều kiện: không gây ảnh hưởng lên những người chuyển sinh khác, không ảnh hưởng quá lớn lên đại vũ trụ${nameLocation[0]}và nhất là ảnh hưởng lên ${nameLocation[1]}`,
					`Ký ức từ thế giới trước sẽ được giữ lại nhưng điểm bắt đầu sẽ là trẻ sơ sinh`,
					`Không thể quay lại ${nameLocation[1]} kể cả sau chết, trừ khi do bên văn phòng triệu tập`
				]
			}
		]
	},
	{
		id: 1,
		title: `Đại vũ trụ${nameLocation[0]}`,
		section: [
			{
				main: `Khái niệm`,
				content: [
			...
			},
			{
				...
				content: [
					`Là những người vốn không thuộc${nameLocation[0]}được lựa chọn từ ${nameLocation[1]} đưa đến với nhiều lí do khác nhau`,
					`Tuy được chuyển sinh nhưng có thể không chung một lục địa, một hành tinh hoặc thậm chí chiều không gian`,
					`Những người chuyển sinh vẫn có thể gặp được nhau tại bất cứ đâu trong${nameLocation[0]}`
				]
			}
		]
	},
		...
		section: [
			...
			},
			{
				...
				content: [
					...
					`${inventory} là nơi chứa các vật phẩm trong một không gian khác mà chỉ sinh vật đó mới truy cập được vào. Chỉ dành cho những sinh vật nào sở hữu khả năng này`,
	...
	},
	{
		...
		section: [
			...
			},
			{
				main: `Lưu ý`,
				content: [
					`Số lượng sinh vật trong thế giới sở hữu ${inventory} là rất hiếm`
				]
			}
		]
	},
